  ...
  template: `
    <div class="mx-auto max-w-2xl space-y-6">
      <div class="flex items-center justify-between">
        ...
        <a routerLink="/products" class="text-sm text-blue-600 hover:text-blue-800">&#8592; Volver</a>
      </div>
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4 rounded-lg border border-gray-200 bg-white p-6">
        ...
        <div class="flex justify-end gap-3">
          <a routerLink="/products" class="rounded-lg border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50">Cancelar</a>
          <button type="submit" [disabled]="submitting()" class="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50">
